...
namespace DotNetN2_MiniSup
{
    public partial class FrmVoucher : Form
    {
        ...
        {
            string mavocher = txt_mavoucher.Text;
        ...
        {
            if(e.RowIndex > 0){
                txt_mavoucher.Text = dataGridView1.Rows[e.RowIndex].Cells["mavoucher"].Value.ToString();
                txt_giatri.Text = dataGridView1.Rows[e.RowIndex].Cells["giatri"].Value.ToString();
                dtp_ngay.Text = dataGridView1.Rows[e.RowIndex].Cells["ngayhethan"].Value.ToString();
            }
        }
